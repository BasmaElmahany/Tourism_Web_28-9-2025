...
export const hotels: Hotel[] = [
  ...
  },
  {
    ...
    imageGallery: [
      "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/26/a0/be/28/horus-resort-menia.jpg?w=1400&h=-1&s=1",
      "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/26/a0/be/2d/horus-resort-menia.jpg?w=1400&h=-1&s=1",
      "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/26/a0/be/31/horus-resort-menia.jpg?w=1400&h=-1&s=1"
    ],
  ...
  {
    id: "6",
    name: { en: "Sea Boat (Floating Hotel)", ar: "سي بوت (فندق عائم)" },
